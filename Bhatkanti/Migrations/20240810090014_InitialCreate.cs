        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_bill_users_UsersUser_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_guide_users_UsersUser_ID",
                        column: x => x.UsersUser_ID,
                        principalTable: "users",
                        principalColumn: "User_ID");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_help_users_UsersUser_ID",
                        column: x => x.UsersUser_ID,
                        principalTable: "users",
                        principalColumn: "User_ID");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_images_users_UsersUser_ID",
                        column: x => x.UsersUser_ID,
                        principalTable: "users",
                        principalColumn: "User_ID");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_place_feedback_users_UsersUser_ID",
                        column: x => x.UsersUser_ID,
                        principalTable: "users",
                        principalColumn: "User_ID");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_wishlist_users_UsersUser_ID",
                        column: x => x.UsersUser_ID,
                        principalTable: "users",
                        principalColumn: "User_ID");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_place_feedback_images_users_UsersUser_ID",
                        column: x => x.UsersUser_ID,
                        principalTable: "users",
                        principalColumn: "User_ID");
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_place_feedback_UsersUser_ID",
                table: "place_feedback",
                column: "UsersUser_ID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_place_feedback_images_UsersUser_ID",
                table: "place_feedback_images",
                column: "UsersUser_ID");
